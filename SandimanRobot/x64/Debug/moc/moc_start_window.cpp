...
QT_MOC_LITERAL(12, 12), // "requestLogin"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 11), // "const char*"
QT_MOC_LITERAL(38, 2), // "ip"
QT_MOC_LITERAL(41, 4), // "port"
QT_MOC_LITERAL(46, 18) // "loginButtonPressed"

    },
    "StartWindow\0requestLogin\0\0const char*\0"
    "ip\0port\0loginButtonPressed"
};
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->requestLogin((*reinterpret_cast< std::add_pointer_t<const char*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->loginButtonPressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StartWindow::*)(const char * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::requestLogin)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<StartWindow, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const char *, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void StartWindow::requestLogin(const char * _t1, int _t2)
{
